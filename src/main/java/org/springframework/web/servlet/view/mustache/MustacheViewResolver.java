...
public class MustacheViewResolver extends AbstractTemplateViewResolver implements ViewResolver,
    ...
    public void setDefaultMustacheFactory(DefaultMustacheFactory defaultMustacheFactory) {
    ...
    protected AbstractUrlBasedView buildView(String viewName) throws Exception {
        ...
        Mustache mustache = defaultMustacheFactory.compile(templateLoader.getTemplate(view.getUrl()),viewName);
